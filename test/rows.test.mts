...
test("agentsRow includes name, source, model, armory chip", () => {
  const a: AgentDef = { name: "scout", description: "d", model: "anthropic/claude-sonnet-4", rolePrompt: "r", todoSync: true, memoryHydrate: true, vision: true, userMemory: false, backend: "pi", sessionKey: "scout", source: "project", filePath: "/x" };
  const r = agentsRow(a);
...
test("agentsRow default model + tools/skills omitted", () => {
  const a: AgentDef = { name: "g", description: "d", rolePrompt: "r", todoSync: false, memoryHydrate: false, vision: false, userMemory: false, backend: "pi", sessionKey: "g", source: "builtin", filePath: "/x" };
  const r = agentsRow(a);
