...
export const subagentParams = Type.Object({
  ...
  skills: Type.Optional(Type.Array(Type.String(), { description: 'Skills to load for this dispatch (opt-in). By default a dispatch loads NO skills (#32 — lean substrate; previously an agent with no skills field loaded ALL ~42 installed skills, ~570K tokens / ~59% of context). Pass skill names from the installed arsenal (e.g. ["executing-plans", "test-driven-development"]) to opt in. When the agent declares skills in its frontmatter, those load automatically and this param overrides them.' })),
});
      ...
      if (params.lifecycle) {
        ...
        const lifecycleFullDeps: LifecycleRunDeps = {
          ...
          spawn: async (o) => spawnSubagent({
            ...
            skillsOverride: params.skills ?? o.skills, backendOverride: o.backend,
